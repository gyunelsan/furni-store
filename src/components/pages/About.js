...
export const About = () => {
  return (
    ...
    <div className=" second_section_about d-flex justify-content-center ">
					<div className="chooseus_content col-lg-6">
						<h2 className='gridHeading'>Why Choose Us</h2>
						<p className='textGrid'>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique.</p>
<br />
						<div className="serviceItems row my-5">
